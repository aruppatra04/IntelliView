...
import HER0_IMG from "../assets/hero_img.png";
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="w-full md:w-1/2">
              <p className="text=[17px] text-gray-900 mr-0 md:mr-20 mb-6">
                ...
                dive deeper into concepts, and organize everything your day.
        ...
        <div>
          <section className="flex items-center justify-center -mt-36">
            <img
              src={HER0_IMG}
              alt="Hero Image"
              className="w-[80vw] rounded-lg border-amber-300 border-1"
            />
          </section>
        </div>
