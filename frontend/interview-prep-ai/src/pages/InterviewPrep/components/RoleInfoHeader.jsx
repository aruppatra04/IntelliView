...
const RoleInfoHeader = ({
  ...
  return (
    <div className="bg-white relative px-11">
      <div className="container mx-auto px-10 md:px-0">
        ...
        <div className="w-[40pvw] md:w-[30vw] h-[200px] flex items-center justify-center bg-white overflow-hidden absolute top-0 right-0">
