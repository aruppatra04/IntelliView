...
const SummaryCard = ({
  ...
  return (
    <div className="bg-white border border-gray-500/40 rounded-xl p-2 overflow-hidden cursor-pointer hover:shadow-xl shadow-gray-300 relative group" onClick={onSelect}>
      <div
