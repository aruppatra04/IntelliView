...
const QuestionCard = ({
  ...
  return (
    <>
        <div className='bg-white rounded-lg mb-4 overflow-hidden py-4 px-5 shadow-xl shadow-gray-100/70 border border-gray-200/80 group'>
            ...
            >
                <div 
                  ref={contentRef}
                  className='mt-4 text-gray-700 bg-blue-50 px-5 py-3 rounded-lg'
                >
